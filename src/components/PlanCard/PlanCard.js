...
export const PlanCard = (props) => {
  return (
    ...
    <article className="flex flex-col shadow-2xl my-4">
      {/* Article Image */}
      <img src="https://source.unsplash.com/collection/1346951/1000x500?sig=1" className="object-cover rounded-t-lg" alt="post" />
      <div className="bg-deep-blue flex flex-col justify-start p-6 rounded-b-lg text-white-lilac text-sans">
