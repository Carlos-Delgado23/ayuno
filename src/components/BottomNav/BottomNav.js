...
class BottomNav extends React.Component {
  ...
  render() {
    const { user, isProfileOpen } = this.state;
          ...
          <div className="fixed inset-x-0 bottom-0 bg-deep-blue shadow">
            <div id="tabs" className="flex justify-between px-8 pt-3 pb-2 text-white-lilac">
              ...
              <div className="relative">
                <div>
                  <button type="button" onClick={this.profileMenu} className="p-1 border-2 border-transparent text-gray-400 rounded-full hover:text-white-lilac focus:outline-none focus:text-white-lilac focus:bg-electric-violet transition duration-150 ease-in-out" id="user-menu" aria-label="User menu" aria-haspopup="true">
                    {/*  Heroicon name: user  */}
                    <svg className="h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
