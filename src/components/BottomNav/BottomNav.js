...
const BottomNav = () => {
  ...
  return (
    <div className="">
      <div id="bottom-navigation" className="md:hidden fixed inset-x-0 bottom-0 bg-deep-blue shadow">
        <div id="bottom-navigation" className="fixed inset-x-0 bottom-0 bg-deep-blue shadow">
          <div id="tabs" className="flex justify-between px-8  text-white-lilac">
